                    ...
                    <div class="span3">
                        <div class="sidebar">
                            <ul class="widget widget-menu unstyled">
                                ...
                                <li><a href="recommendations.php"><i class="menu-icon icon-list"></i>Pending Requests</a></li>
                            </ul>
                            <ul class="widget widget-menu unstyled">
                    ...
                    <div class="span9">
                        ...
                        <table class="table" id = "tables">
                            ...
                            $sql="select * from LMS.record,LMS.book
                             where record.BookId=book.BookId AND RollNo='$rollno' AND Date_of_Issue is NULL";
                            ...
                            ?>
                                    <tr>
                                      ...
                                      <td><?php echo $name ?></td>
                                      <!-- <td></td> -->
                                      <td><center> <a class="btn btn-danger" href="deleterequest.php?id=<?php echo $bookid ?>">Delete Request</a></center></td>
                                  </tr>
                                  <?php } ?>
                               </tbody>
                                </table>

                    ...
                    <div class="span9">
                        <div class="module">
                            ...
                            <div class="module-body">
                                ...
                                // echo $rollno;
                                $sql="select * from LMS.admin where RollNo='$rollno'";
                                ...
                                <form class="form-horizontal row-fluid" action="edit_admin_details.php?id=<?php echo $rollno ?>" method="post">
                                    ...
                                    <div class="control-group">
                                            <div class="controls">
                                                <button type="submit" name="submit"class="btn-primary"><center>Update Detail</center></button>
                                            </div>
                                        </div>                                                                     
...
$sql1="update LMS.admin set name='$name', email='$email', mobile='$mobno', password='$pswd' where RollNo='$rollno'";
echo $sql1;

...
<div id="divToPrint" >
    ...
    <center><h1 sttle="color:green">Patan multiple campus</h1></center>
  <div >
                 <div class="span9">
                         <?php
...
$con1 = mysqli_connect("localhost","root","","lms");
    ...
    // Display result
    // echo "<h2>Total number of books :</h2>" ,$rowcount;
    printf("<center><h4> Total number of books : %d\n </h4></center>", $rowcount);
...
//---------------------------------------------------------------------------------------------
   $sql1 = "SELECT * from user";
    ...
    // Display result
    printf("<center><h4>Total number of Students : %d\n </h4></center>", $rowcount1);
}
echo "";
                   ?><center> 
                                    ...
                                    <tr>
                                      ...
                                      <td><b><?php echo $total ?></b></td>
                                        <!-- <td><center>
                                            ...
                                            <a href="generatecode.php?id=<?php echo $bookid; ?>" class="btn btn-primary">Book codes</a>

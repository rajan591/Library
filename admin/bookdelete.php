                    ...
                    <div class="span9">
                        ...
                        <table class="table" id = "tables">
                            ...
                            ?>
                                ...
                                echo '<select name="type">';
                                    $sql1="select code from LMS.bookcode where BookId='$bookid'";
                        ...
                        echo '</select>';
                                      ...
                                      <td><center>
                                        <?php
                                        if($avail > 0)
                                        {echo "<button onclick='delet(".$bookid.",".$avail.")'>Delete</button>";}
                                            // {echo "<button onclick='alert('Access Denied!!!')'>Delete</button>";}
                                         ?>
